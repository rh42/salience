...
const DUAL_SUMMARIES = {
  "AMYGDALA+CLAUSTRUM": "Something flags, and you immediately notice yourself noticing. The amygdala catches the signal; the claustrum watches you catch it. That gives you unusually fine-grained self-awareness and occasionally leaves you unsure whether you are reacting to the world or to your reaction.",
  ...
  "CLAUSTRUM+PFC": "You watch yourself think. The prefrontal cortex edits; the claustrum observes the editing. This feels either like a superpower or like the reason you struggle to turn your brain off.",
  "HABENULA+HIPPOCAMPUS": "You reach back and feel the gap between what happened and what you expected. The hippocampus reconstructs; the habenula measures the reconstruction against the original plan. You are good at spotting when a story has shifted without being announced.",
  "HABENULA+INSULA": "You feel gaps. The habenula measures the distance between expectation and outcome; the insula carries that as a physical sensation. When something goes wrong, your body files the report before your thoughts catch up.",
